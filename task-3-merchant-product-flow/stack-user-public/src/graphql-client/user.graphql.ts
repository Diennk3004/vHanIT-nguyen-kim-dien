...
const CREATE_USER = gql`
  mutation CreateUser($email: String!, $password: String!, $fullname: String!, $dialing_code: String!, $phone: String!, $locale: String!) {
...
`;
export { CREATE_USER, LOGIN, LOGOUT, CHECK_VALID_TOKEN, USER_BY_OLD_PASSWORD, CHANGE_PASSWORD, GET_USERS_BY_EMAIL, SEND_EMAIL_USER, GET_USERS_BY_PHONE, RESET_PASSWORD, SEND_EMAIL_FOR_PASSWORD, GET_USER_DETAIL, UPDATE_ACCOUNT, USERS_BY_EMAIL_AND_ID, USERS_BY_PHONE_AND_ID, UPDATE_USER_LOCALE, LOGIN_IN_BY_EMAIL };
